...
const colorVariants: Record<ColorVariant, { outer: string; inner: string; button: string; textColor: string; textShadow: string }> = {
  ...
  primary: { outer: "bg-gradient-to-b from-[#000] to-[#A0A0A0]", inner: "bg-gradient-to-b from-amber-400 via-amber-600 to-amber-800", button: "bg-gradient-to-b from-amber-400 to-amber-600", textColor: "text-white", textShadow: "[text-shadow:_0_-1px_0_rgb(180_120_0_/_100%)]" },
  ...
  ({ children, className, variant = "default", ...props }, ref) => {
    ...
    return (
      ...
      >
        ...
        <button
          ref={ref}
          className={cn("relative z-10 m-[1px] rounded-md inline-flex h-11 transform-gpu cursor-pointer items-center justify-center overflow-hidden px-6 py-2 text-sm leading-none font-semibold will-change-transform outline-none", colors.button, colors.textColor, colors.textShadow, className)}
